<div class="contianer">
    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Vercel_logo_black.svg/2560px-Vercel_logo_black.svg.png" alt="Vercel Logo" width="120" />
    <div style="font-size: 24px; font-weight: 700; margin: 20px 0 20px 0;">
        SvelteKit on Vercel
    </div> 
    <div>
        ...
        <ul>
            ...
            <li>
                Vercel recently launched [Edge Functions](https://vercel.com/features/edge-functions), which allow you to run JavaScript code on their globally-distributed edge network. SvelteKit supports these Edge Functions, meaning you can serve your users dynamically-rendered pages at the same speed you would serve static files from a CDN, drastically improving the performance and reliability of your SvelteKit app.
            </li>
            <li>
